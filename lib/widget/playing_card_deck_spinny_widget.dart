...
class _PlayingCardDeckSpinnyWidgetState extends State<PlayingCardDeckSpinnyWidget> {
  ...
  void initState() {
    ...
    _rotationX = RandomHelper.returnRandomDouble(min: -180.0, max: 180.0);
    _rotationZ = RandomHelper.returnRandomDouble(min: -180.0, max: 180.0);
